...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		List<Integer> neserazenepole = new ArrayList<Integer>();
for(int i = 0; i<getNumVertices();i++){
		neserazenepole.add(getNeighbors(i).size() + getInNeighbors(i).size());
		}
		

			List<Integer> sortedList = neserazenepole.stream().sorted((s1, s2) -> {
